...
uses {ReceiverForm}uMain, System.SysUtils;
...
begin
  //fmmain.MessageIdEdit.Text := FStompFrame.GetHeaders.Value('message-id');
end;

procedure TThreadReceiver.UpdateMessageMemo;
begin
  fmmain.MessageMemo.Lines.Add('Wait Messages....');
end;
